...
public class ConsumerRunner {
  ...
  private static final String RABBITMQ_URI_STRING = "amqp://guest:guest@localhost:5672";  // TODO: check before run
  ...
  private static final String REDIS_HOST = "localhost";                                   // TODO: check before run
  ...
  // To use a MongoDB cluster, deploy multiple instances, set up replica set and change the connection.
  // e.g. "mongodb://<IP_0>:27017,<IP_0>:27017,<IP_0>:27017/?replicaSet=<replica_set_name>&retryWrites=true&w=majority"
