...
import com.upic.model.task.TaskParams;
...
public class PostRequestMaker {
  ...
  public PostRequestMaker(int maxRetries, Random rand, ApiClient apiClient, Logger globalLogger) {
    ...
    this.resortID = rand.nextInt(TaskParams.RESORT_ID_MAX.getInt()) + 1;
    this.skierID = rand.nextInt(TaskParams.SKIER_ID_MAX.getInt()) + 1;
    this.liftRide = new LiftRide();
    this.liftRide.setTime(rand.nextInt(TaskParams.LIFT_ID_MAX.getInt()) + 1);
    this.liftRide.setLiftID(rand.nextInt(TaskParams.LIFT_ID_MAX.getInt()) + 1);
    this.seasonID = "" + TaskParams.SEASON_ID_MAX.getInt();
    this.dayID = "" + TaskParams.DAY_ID_MAX.getInt();
